...
function ContactForm() {
    const [state, handleSubmit] = useForm("mblonzjz");
    if (state.succeeded) {
    return <p className="text-[#EAE4D5] text-center">Thanks for your message!</p>;
    }
    return (
        <form onSubmit={handleSubmit} className="max-w-2xl mx-auto space-y-6 text-[#B6B09F]">
            <div>
