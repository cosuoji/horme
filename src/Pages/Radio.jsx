...
const Radio = () => {
  ...
  const campaigns = [
    ...
    {
      image: bigthings,
      song: "Young Jonn x Seyi Vibez x Kizz Daniel - Big Big Things",
    },
      ...
      <div className="min-h-screen bg-[#0a0a0a] text-[#B6B09F] px-6 md:px-20 py-20 space-y-14 animate-fadeUp">
        ...
        <div>
          ...
          <p className="text-lg leading-relaxed">
            ...
            We don’t just submit tracks to radio—we engineer campaigns with the
            right OAP's and Librarians to get your music heard. Our strategic
            radio placements during peak periods turn rotations into real-world
            hype.
          </p>
          ...
          <div>
            ...
            <ul className="text-2xl py-6">
              <li className="font-light text-lg">
                <span className="font-bold">📻 Power Rotation Placements:</span>{" "}
                Guaranteed spins on Nigeria’s Top 20 stations
              </li>
              <li className="font-light text-lg">
                <span className="font-bold">🎤 DJ/OAPS:</span> Exclusive
                relationships with key tastemakers who break hits first
              </li>
              <li className="font-light text-lg">
                <span className="font-bold">📊 Charts: </span>Strategic timing
                to land on official charts (Soundcharts, Radiomonitor)
              </li>
            </ul>
          </div>
        </div>
