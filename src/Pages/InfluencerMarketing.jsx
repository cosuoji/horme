...
const InfluencerMarketing = () => {
  ...
  useSEO({ title: "Influencer Marketing" });
      ...
      <div className="min-h-screen bg-[#0a0a0a] text-[#B6B09F] px-6 md:px-20 py-20 space-y-14 animate-fadeUp">
        ...
        <div>
          ...
          <p className="text-lg leading-relaxed">
            We craft high-impact influencer campaigns that stick to our clients
            carefully curated vision. Our data-driven approach pairs your brand
            with authentic creators who don’t just rack up likes—they drive
            conversions. It's also in our best interest to pick influencers who
            fit the aesthetic of the campaign, doesn't matter if it's a single
            or an album we'll curate a seamless experience. <br></br>
          </p>

          <ul className="text-2xl font-bold mt-10">
            {" "}
            Why Our Strategy Works
            <li className="font-light text-lg py-1">
              <span className="font-bold">Instagram Aesthetic Precision</span>:
              Curated content that blends seamlessly into user feeds while
              performing like performance ads
            </li>
            <li className="font-light text-lg py-1">
              <span className="font-bold">Platform-Specific Talent:</span>{" "}
              Handpicked nano/micro-influencers with real engagement - that fit
              the campaign brief (not just vanity metrics)
            </li>
            <li className="font-light text-lg py-1">
              <span className="font-bold">Trackable ROI:</span> From UTM tags to
              promo codes, we prove our campaigns move product
            </li>
          </ul>
        </div>
        ...
        {/* Campaign Media Grid */}
        <div>
          <h3 className="text-3xl font-bold text-[#EAE4D5] mb-10">
            ...
            {campaigns.map((item, index) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center">
                  <span className="text-[#EAE4D5] font-semibold text-center px-2 text-sm sm:text-base">
                    {item.song}
                  </span>
                </div>
              </div>
