      ...
      <div className="min-h-screen bg-[#0a0a0a] text-[#B6B09F] px-6 md:px-20 py-20 space-y-14 animate-fadeUp">
        ...
        <div>
          ...
          <p className="text-lg leading-relaxed">
            In Nigeria's every expanding, endlessly competitive entertainment
            scene, visibility is currency — and we know how to spend it. From
            breaking new artists to shaping major comebacks, we create PR
            strategies that cut through the noise and get results. Whether it’s
            placing your music on the right blogs, securing interviews on top
            platforms — we’ve got the network and the know-how.<br></br>
            We speak the language of the streets and the industry.<br></br> Our
            relationships with key media houses, influencers, OAPs, and culture
            drivers mean your story lands where it matters most.<br></br>
            This is PR built for the Nigerian market — bold, fast, and
            effective.
          </p>
        </div>
